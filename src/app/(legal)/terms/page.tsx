...
export default function Terms() {
  return (
    <>
      ...
      <p>The Service also includes:</p>
      <ul>
        <li><strong>Jira integration:</strong> You may connect a Jira workspace to sync issues
          and trigger runs from Jira tickets</li>
        <li><strong>Google OAuth login:</strong> You may authenticate to the dashboard using
          your Google account</li>
        <li><strong>MCP tool servers:</strong> You may configure Model Context Protocol (MCP)
          tool servers that the AI agent can invoke during runs. Third-party MCP servers are
          operated by you or third parties and are not part of the Service</li>
        <li><strong>AI-powered plans:</strong> The Service uses large language models to
          generate implementation plans and code changes</li>
      </ul>
      ...
      <h3>5.2 Open-Source Compliance</h3>
      <p>AI-generated code may inadvertently resemble existing open-source code. You are solely
        responsible for ensuring that any code you merge complies with applicable open-source
        licenses and does not infringe third-party intellectual property rights.</p>
      <h3>5.3 Our Service</h3>
      ...
      <p>To the extent permitted by applicable law, you agree to indemnify, defend, and hold
        harmless Coderhelm and its officers, directors, employees, agents, and affiliates from
      ...
      <p>You may not use the Service in violation of any applicable export control or sanctions
        laws, including those of the United States and the European Union. You represent that
        you are not located in, or a national or resident of, any country subject to comprehensive
        U.S. sanctions, and that you are not on any U.S. government denied-party list.</p>
