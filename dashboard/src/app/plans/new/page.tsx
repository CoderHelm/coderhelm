              ...
              {isStreamingPlan && !draft ? (
                ...
                <>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {task.acceptance_criteria && (
                              <div className="mt-2">
                                ...
                                <p className="text-xs text-zinc-500 leading-relaxed whitespace-pre-wrap">{task.acceptance_criteria}</p>
                              </div>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="pt-2 border-t border-zinc-800">
                    <p className="text-xs text-zinc-500 mb-2">Create issues in</p>
                  ...
                  <button
                    onClick={savePlan}
                    disabled={saving}
                    className="w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-500 transition-colors disabled:opacity-50 cursor-pointer"
                  >
