              ...
              {isStreamingPlan && !draft ? (
                ...
                <>
                  ...
                  <button
                    onClick={savePlan}
                    disabled={saving}
                    className="w-full px-4 py-2.5 bg-blue-600 text-white hover:bg-blue-500 rounded-lg text-sm font-semibold transition-colors disabled:opacity-50 cursor-pointer"
                  >
