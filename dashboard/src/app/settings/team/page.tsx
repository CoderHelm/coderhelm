          ...
          <table className="w-full text-xs">
            ...
            <tbody className="text-zinc-400">
              {[
                ...
                { perm: "View billing & invoices", viewer: false, member: false, admin: true, owner: true },
                ...
                { perm: "Manage MCP servers", viewer: false, member: false, admin: true, owner: true },
                ...
                { perm: "Rename team", viewer: false, member: false, admin: false, owner: true },
                { perm: "Reset account data", viewer: false, member: false, admin: false, owner: true },
              ].map((row) => (
